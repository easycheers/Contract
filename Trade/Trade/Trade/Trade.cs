...
namespace Trade
{
    public class Trade : SmartContract
    {
        ...
        private static readonly byte[] Owner = "AX8XL9VGbc6v8PkycHPyFuoCTKiQVTBzXp".ToScriptHash(); //Owner Address
        ...
        [DisplayName("name")]
        public static string Name() => "Trade Company Stock"; //name of the token

        [DisplayName("symbol")]
        public static string Symbol() => "TRD"; //symbol of the token
