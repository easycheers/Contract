...
namespace Oil
{
    public class Oil : SmartContract
    {
        ...
        private static readonly byte[] Owner = "ASB7XpBoS4BQCsbQkMeMiN8nBm3f5TGkgS".ToScriptHash(); //Owner Address
        private static readonly BigInteger total_amount = (BigInteger)50000000; // total token amount
        ...
        [DisplayName("name")]
        public static string Name() => "Oil Company Stock"; //name of the token

        [DisplayName("symbol")]
        public static string Symbol() => "OIL"; //symbol of the token
